...
/**
 * Advanced replytocom callback.
 */
function seopress_advanced_advanced_replytocom_callback() {
	$options = get_option( 'seopress_advanced_option_name' );

	$check = isset( $options['seopress_advanced_advanced_replytocom'] ) ? $options['seopress_advanced_advanced_replytocom'] : null; ?>
...
<p class="description">
	...
	<?php
	if ( isset( $options['seopress_advanced_advanced_replytocom'] ) ) {
		esc_attr( $options['seopress_advanced_advanced_replytocom'] );
	}
}

/**
 * Advanced noreferrer callback.
 */
function seopress_advanced_advanced_noreferrer_callback() {
	$options = get_option( 'seopress_advanced_option_name' );

	$check = isset( $options['seopress_advanced_advanced_noreferrer'] ) ? $options['seopress_advanced_advanced_noreferrer'] : null;
	?>
...
<p class="description">
	...
	<?php
	if ( isset( $options['seopress_advanced_advanced_noreferrer'] ) ) {
		esc_attr( $options['seopress_advanced_advanced_noreferrer'] );
	}
}

/**
 * Advanced tax desc editor callback.
 */
function seopress_advanced_advanced_tax_desc_editor_callback() {
	$options = get_option( 'seopress_advanced_option_name' );

	$check = isset( $options['seopress_advanced_advanced_tax_desc_editor'] ) ? $options['seopress_advanced_advanced_tax_desc_editor'] : null;
	?>
...
<label for="seopress_advanced_advanced_tax_desc_editor">
	...
	<?php
	if ( isset( $options['seopress_advanced_advanced_tax_desc_editor'] ) ) {
		esc_attr( $options['seopress_advanced_advanced_tax_desc_editor'] );
	}
}

/**
 * Advanced category url callback.
 */
function seopress_advanced_advanced_category_url_callback() {
	$options = get_option( 'seopress_advanced_option_name' );

	$check = isset( $options['seopress_advanced_advanced_category_url'] ) ? $options['seopress_advanced_advanced_category_url'] : null;
	?>
...
/**
 * Advanced product cat url callback.
 */
function seopress_advanced_advanced_product_cat_url_callback() {
	if ( is_plugin_active( 'woocommerce/woocommerce.php' ) ) {
		$options = get_option( 'seopress_advanced_option_name' );

		$check = isset( $options['seopress_advanced_advanced_product_cat_url'] ) ? $options['seopress_advanced_advanced_product_cat_url'] : null;
...
/**
 * Advanced wp generator callback.
 */
function seopress_advanced_advanced_wp_generator_callback() {
	$options = get_option( 'seopress_advanced_option_name' );

	$check = isset( $options['seopress_advanced_advanced_wp_generator'] ) ? $options['seopress_advanced_advanced_wp_generator'] : null;
	?>
...
<pre><?php echo esc_attr( '<meta name="generator" content="WordPress 6.2" />' ); ?></pre>
	...
	<?php
	if ( isset( $options['seopress_advanced_advanced_wp_generator'] ) ) {
		esc_attr( $options['seopress_advanced_advanced_wp_generator'] );
	}
}

/**
 * Advanced hentry callback.
 */
function seopress_advanced_advanced_hentry_callback() {
	$options = get_option( 'seopress_advanced_option_name' );

	$check = isset( $options['seopress_advanced_advanced_hentry'] ) ? $options['seopress_advanced_advanced_hentry'] : null;
	?>
...
<label for="seopress_advanced_advanced_hentry">
	...
	<?php
	if ( isset( $options['seopress_advanced_advanced_hentry'] ) ) {
		esc_attr( $options['seopress_advanced_advanced_hentry'] );
	}
}

/**
 * Advanced comments author url callback.
 */
function seopress_advanced_advanced_comments_author_url_callback() {
	$options = get_option( 'seopress_advanced_option_name' );

	$check = isset( $options['seopress_advanced_advanced_comments_author_url'] ) ? $options['seopress_advanced_advanced_comments_author_url'] : null;
	?>
...
<label for="seopress_advanced_advanced_comments_author_url">
	...
	<?php
	if ( isset( $options['seopress_advanced_advanced_comments_author_url'] ) ) {
		esc_attr( $options['seopress_advanced_advanced_comments_author_url'] );
	}
}

/**
 * Advanced comments website callback.
 */
function seopress_advanced_advanced_comments_website_callback() {
	$options = get_option( 'seopress_advanced_option_name' );

	$check = isset( $options['seopress_advanced_advanced_comments_website'] ) ? $options['seopress_advanced_advanced_comments_website'] : null;
	?>
...
<label for="seopress_advanced_advanced_comments_website">
	...
	<?php
	if ( isset( $options['seopress_advanced_advanced_comments_website'] ) ) {
		esc_attr( $options['seopress_advanced_advanced_comments_website'] );
	}
}

/**
 * Advanced comments form link callback.
 */
function seopress_advanced_advanced_comments_form_link_callback() {
	$options = get_option( 'seopress_advanced_option_name' );

	$check = isset( $options['seopress_advanced_advanced_comments_form_link'] ) ? $options['seopress_advanced_advanced_comments_form_link'] : null;
	?>
...
<pre>https://www.example.com/my-blog-post/#respond</pre>
	...
	<?php
	if ( isset( $options['seopress_advanced_advanced_comments_form_link'] ) ) {
		esc_attr( $options['seopress_advanced_advanced_comments_form_link'] );
	}
}

/**
 * Advanced wp shortlink callback.
 */
function seopress_advanced_advanced_wp_shortlink_callback() {
	$options = get_option( 'seopress_advanced_option_name' );

	$check = isset( $options['seopress_advanced_advanced_wp_shortlink'] ) ? $options['seopress_advanced_advanced_wp_shortlink'] : null;
	?>
...
<pre>&lt;link rel="shortlink" href="https://www.example.com/" /&gt;</pre>
	...
	<?php
	if ( isset( $options['seopress_advanced_advanced_wp_shortlink'] ) ) {
		esc_attr( $options['seopress_advanced_advanced_wp_shortlink'] );
	}
}

/**
 * Advanced wp wlw callback.
 */
function seopress_advanced_advanced_wp_wlw_callback() {
	$options = get_option( 'seopress_advanced_option_name' );

	$check = isset( $options['seopress_advanced_advanced_wp_wlw'] ) ? $options['seopress_advanced_advanced_wp_wlw'] : null;
	?>
...
<pre>&lt;link rel="wlwmanifest" type="application/wlwmanifest+xml" href="https://www.example.com/wp-includes/wlwmanifest.xml" /&gt;</pre>
	...
	<?php
	if ( isset( $options['seopress_advanced_advanced_wp_wlw'] ) ) {
		esc_attr( $options['seopress_advanced_advanced_wp_wlw'] );
	}
}

/**
 * Advanced wp rsd callback.
 */
function seopress_advanced_advanced_wp_rsd_callback() {
	$options = get_option( 'seopress_advanced_option_name' );

	$check = isset( $options['seopress_advanced_advanced_wp_rsd'] ) ? $options['seopress_advanced_advanced_wp_rsd'] : null;
	?>
...
<pre>&lt;link rel="EditURI" type="application/rsd+xml" title="RSD" href="https://www.example.com/xmlrpc.php?rsd" /&gt;</pre>
	...
	<?php
	if ( isset( $options['seopress_advanced_advanced_wp_rsd'] ) ) {
		esc_attr( $options['seopress_advanced_advanced_wp_rsd'] );
	}
}

/**
 * Advanced wp oembed callback.
 */
function seopress_advanced_advanced_wp_oembed_callback() {
	$options = get_option( 'seopress_advanced_option_name' );

	$check = isset( $options['seopress_advanced_advanced_wp_oembed'] ) ? $options['seopress_advanced_advanced_wp_oembed'] : null;
	?>
...
<pre>&lt;link rel="alternate" type="text/xml+oembed" href="https://www.example.com/wp-json/oembed/1.0/embed?url=https://www.example.com/my-blog-post/&format=xml" /&gt;</pre>
	...
	<?php
	if ( isset( $options['seopress_advanced_advanced_wp_oembed'] ) ) {
		esc_attr( $options['seopress_advanced_advanced_wp_oembed'] );
	}
}

/**
 * Advanced wp x pingback callback.
 */
function seopress_advanced_advanced_wp_x_pingback_callback() {
	$options = get_option( 'seopress_advanced_option_name' );

	$check = isset( $options['seopress_advanced_advanced_wp_x_pingback'] ) ? $options['seopress_advanced_advanced_wp_x_pingback'] : null;
	?>
...
<pre>X-Pingback: https://www.example.com/xmlrpc.php</pre>
	...
	<?php
	if ( isset( $options['seopress_advanced_advanced_wp_x_pingback'] ) ) {
		esc_attr( $options['seopress_advanced_advanced_wp_x_pingback'] );
	}
}

/**
 * Advanced wp x powered by callback.
 */
function seopress_advanced_advanced_wp_x_powered_by_callback() {
	$options = get_option( 'seopress_advanced_option_name' );

	$check = isset( $options['seopress_advanced_advanced_wp_x_powered_by'] ) ? $options['seopress_advanced_advanced_wp_x_powered_by'] : null;
	?>
...
<pre>X-Powered-By: PHP/8.4</pre>
	...
	<?php
	if ( isset( $options['seopress_advanced_advanced_wp_x_powered_by'] ) ) {
		esc_attr( $options['seopress_advanced_advanced_wp_x_powered_by'] );
	}
}

/**
 * Advanced emoji callback.
 */
function seopress_advanced_advanced_emoji_callback() {
	$options = get_option( 'seopress_advanced_option_name' );

	$check = isset( $options['seopress_advanced_advanced_emoji'] ) ? $options['seopress_advanced_advanced_emoji'] : null;
	?>
...
<p class="description">
	...
	<?php
	if ( isset( $options['seopress_advanced_advanced_emoji'] ) ) {
		esc_attr( $options['seopress_advanced_advanced_emoji'] );
	}
}

/**
 * Advanced google callback.
 */
...
function seopress_advanced_appearance_adminbar_callback() {
	...
	$check = isset( $options['seopress_advanced_appearance_adminbar'] ) ? $options['seopress_advanced_appearance_adminbar'] : null;
	?>
...
<label for="seopress_advanced_appearance_adminbar">
	...
	<?php
	if ( isset( $options['seopress_advanced_appearance_adminbar'] ) ) {
		esc_attr( $options['seopress_advanced_appearance_adminbar'] );
	}
}

/**
 * Advanced adminbar counter callback.
 */
function seopress_advanced_appearance_adminbar_counter_callback() {
	$options = get_option( 'seopress_advanced_option_name' );

	$check = isset( $options['seopress_advanced_appearance_adminbar_counter'] ) ? $options['seopress_advanced_appearance_adminbar_counter'] : null;
	?>
...
<label for="seopress_advanced_appearance_adminbar_counter">
	...
	<?php
	if ( isset( $options['seopress_advanced_appearance_adminbar_counter'] ) ) {
		esc_attr( $options['seopress_advanced_appearance_adminbar_counter'] );
	}
}

/**
 * Advanced universal metabox disable callback.
 */
function seopress_advanced_appearance_universal_metabox_disable_callback() {
	...
	if ( ! $options ) {
		...
		$check = isset( $options['seopress_advanced_appearance_universal_metabox_disable'] ) && '1' === $options['seopress_advanced_appearance_universal_metabox_disable'] ? true : false;
	}
	?>
...
/**
 * Advanced universal metabox callback.
 */
function seopress_advanced_appearance_universal_metabox_callback() {
	...
	if ( ! $options ) {
		...
		$check = isset( $options['seopress_advanced_appearance_universal_metabox'] ) && '1' === $options['seopress_advanced_appearance_universal_metabox'] ? true : false;
	}
	?>
...
/**
 * Advanced adminbar noindex callback.
 */
function seopress_advanced_appearance_adminbar_noindex_callback() {
	$options = get_option( 'seopress_advanced_option_name' );

	$check = isset( $options['seopress_advanced_appearance_adminbar_noindex'] ) ? $options['seopress_advanced_appearance_adminbar_noindex'] : null;
	?>
...
<label for="seopress_advanced_appearance_adminbar_noindex">
	...
	<?php
	if ( isset( $options['seopress_advanced_appearance_adminbar_noindex'] ) ) {
		esc_attr( $options['seopress_advanced_appearance_adminbar_noindex'] );
	}
}

/**
 * Advanced metaboxe position callback.
 */
...
<select id="seopress_advanced_appearance_metaboxe_position"
	...
	<?php
	if ( isset( $options['seopress_advanced_appearance_metaboxe_position'] ) ) {
		esc_attr( $options['seopress_advanced_appearance_metaboxe_position'] );
	}
}

/**
 * Advanced title column callback.
 */
function seopress_advanced_appearance_title_col_callback() {
	$options = get_option( 'seopress_advanced_option_name' );

	$check = isset( $options['seopress_advanced_appearance_title_col'] ) ? $options['seopress_advanced_appearance_title_col'] : null;
	?>
...
<label for="seopress_advanced_appearance_title_col">
	...
	<?php
	if ( isset( $options['seopress_advanced_appearance_title_col'] ) ) {
		esc_attr( $options['seopress_advanced_appearance_title_col'] );
	}
}

/**
 * Advanced meta description column callback.
 */
function seopress_advanced_appearance_meta_desc_col_callback() {
	$options = get_option( 'seopress_advanced_option_name' );

	$check = isset( $options['seopress_advanced_appearance_meta_desc_col'] ) ? $options['seopress_advanced_appearance_meta_desc_col'] : null;
	?>
...
<label for="seopress_advanced_appearance_meta_desc_col">
	...
	<?php
	if ( isset( $options['seopress_advanced_appearance_meta_desc_col'] ) ) {
		esc_attr( $options['seopress_advanced_appearance_meta_desc_col'] );
	}
}

/**
 * Advanced redirect enable column callback.
 */
function seopress_advanced_appearance_redirect_enable_col_callback() {
	$options = get_option( 'seopress_advanced_option_name' );

	$check = isset( $options['seopress_advanced_appearance_redirect_enable_col'] ) ? $options['seopress_advanced_appearance_redirect_enable_col'] : null;
	?>
...
<label for="seopress_advanced_appearance_redirect_enable_col">
	...
	<?php
	if ( isset( $options['seopress_advanced_appearance_redirect_enable_col'] ) ) {
		esc_attr( $options['seopress_advanced_appearance_redirect_enable_col'] );
	}
}

/**
 * Advanced redirect url column callback.
 */
function seopress_advanced_appearance_redirect_url_col_callback() {
	$options = get_option( 'seopress_advanced_option_name' );

	$check = isset( $options['seopress_advanced_appearance_redirect_url_col'] ) ? $options['seopress_advanced_appearance_redirect_url_col'] : null;
	?>
...
<label for="seopress_advanced_appearance_redirect_url_col">
	...
	<?php
	if ( isset( $options['seopress_advanced_appearance_redirect_url_col'] ) ) {
		esc_attr( $options['seopress_advanced_appearance_redirect_url_col'] );
	}
}

/**
 * Advanced canonical column callback.
 */
function seopress_advanced_appearance_canonical_callback() {
	$options = get_option( 'seopress_advanced_option_name' );

	$check = isset( $options['seopress_advanced_appearance_canonical'] ) ? $options['seopress_advanced_appearance_canonical'] : null;
	?>
...
<label for="seopress_advanced_appearance_canonical">
	...
	<?php
	if ( isset( $options['seopress_advanced_appearance_canonical'] ) ) {
		esc_attr( $options['seopress_advanced_appearance_canonical'] );
	}
}

/**
 * Advanced target keyword column callback.
 */
function seopress_advanced_appearance_target_kw_col_callback() {
	$options = get_option( 'seopress_advanced_option_name' );

	$check = isset( $options['seopress_advanced_appearance_target_kw_col'] ) ? $options['seopress_advanced_appearance_target_kw_col'] : null;
	?>
...
<label for="seopress_advanced_appearance_target_kw_col">
	...
	<?php
	if ( isset( $options['seopress_advanced_appearance_target_kw_col'] ) ) {
		esc_attr( $options['seopress_advanced_appearance_target_kw_col'] );
	}
}

/**
 * Advanced noindex column callback.
 */
function seopress_advanced_appearance_noindex_col_callback() {
	$options = get_option( 'seopress_advanced_option_name' );

	$check = isset( $options['seopress_advanced_appearance_noindex_col'] ) ? $options['seopress_advanced_appearance_noindex_col'] : null;
	?>
...
<label for="seopress_advanced_appearance_noindex_col">
	...
	<?php
	if ( isset( $options['seopress_advanced_appearance_noindex_col'] ) ) {
		esc_attr( $options['seopress_advanced_appearance_noindex_col'] );
	}
}

/**
 * Advanced nofollow column callback.
 */
function seopress_advanced_appearance_nofollow_col_callback() {
	$options = get_option( 'seopress_advanced_option_name' );

	$check = isset( $options['seopress_advanced_appearance_nofollow_col'] ) ? $options['seopress_advanced_appearance_nofollow_col'] : null;
	?>
...
<label for="seopress_advanced_appearance_nofollow_col">
	...
	<?php
	if ( isset( $options['seopress_advanced_appearance_nofollow_col'] ) ) {
		esc_attr( $options['seopress_advanced_appearance_nofollow_col'] );
	}
}

/**
 * Advanced inbound column callback.
 */
function seopress_advanced_appearance_inbound_col_callback() {
	$options = get_option( 'seopress_advanced_option_name' );

	$check = isset( $options['seopress_advanced_appearance_inbound_col'] ) ? $options['seopress_advanced_appearance_inbound_col'] : null;
	?>
...
<label for="seopress_advanced_appearance_inbound_col">
	...
	<?php
	if ( isset( $options['seopress_advanced_appearance_inbound_col'] ) ) {
		esc_attr( $options['seopress_advanced_appearance_inbound_col'] );
	}
}

/**
 * Advanced outbound column callback.
 */
function seopress_advanced_appearance_outbound_col_callback() {
	$options = get_option( 'seopress_advanced_option_name' );

	$check = isset( $options['seopress_advanced_appearance_outbound_col'] ) ? $options['seopress_advanced_appearance_outbound_col'] : null;
	?>
...
<label for="seopress_advanced_appearance_outbound_col">
	...
	<?php
	if ( isset( $options['seopress_advanced_appearance_outbound_col'] ) ) {
		esc_attr( $options['seopress_advanced_appearance_outbound_col'] );
	}
}

/**
 * Advanced score column callback.
 */
function seopress_advanced_appearance_score_col_callback() {
	$options = get_option( 'seopress_advanced_option_name' );

	$check = isset( $options['seopress_advanced_appearance_score_col'] ) ? $options['seopress_advanced_appearance_score_col'] : null;
	?>
...
/**
 * Advanced ca metaboxe callback.
 */
function seopress_advanced_appearance_ca_metaboxe_callback() {
	$options = get_option( 'seopress_advanced_option_name' );

	$check = isset( $options['seopress_advanced_appearance_ca_metaboxe'] ) ? $options['seopress_advanced_appearance_ca_metaboxe'] : null;
	?>
...
<p class="description">
	...
	<?php
	if ( isset( $options['seopress_advanced_appearance_ca_metaboxe'] ) ) {
		esc_attr( $options['seopress_advanced_appearance_ca_metaboxe'] );
	}
}

/**
 * Advanced security metaboxe role callback.
 */
function seopress_advanced_security_metaboxe_role_callback() {
	...
	foreach ( $wp_roles->get_names() as $key => $value ) {
		$check = isset( $options['seopress_advanced_security_metaboxe_role'][ $key ] ) ? $options['seopress_advanced_security_metaboxe_role'][ $key ] : null;
		?>
	...
	<p>
		...
		<?php
		if ( isset( $options['seopress_advanced_security_metaboxe_role'][ $key ] ) ) {
...
/**
 * Advanced security metaboxe ca role callback.
 */
function seopress_advanced_security_metaboxe_ca_role_callback() {
	...
	<?php
	foreach ( $wp_roles->get_names() as $key => $value ) {
		$check = isset( $options['seopress_advanced_security_metaboxe_ca_role'][ $key ] ) ? $options['seopress_advanced_security_metaboxe_ca_role'][ $key ] : null;
		?>
	...
	<p>
		...
		<?php
		if ( isset( $options['seopress_advanced_security_metaboxe_ca_role'][ $key ] ) ) {
