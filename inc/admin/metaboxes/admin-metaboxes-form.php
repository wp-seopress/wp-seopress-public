                    ...
                    <div id="tabs-2">
                        <div class="box-left">
                            <p class="description-alt desc-fb">
                                ...
                                <?php _e('LinkedIn, Instagram, WhatsApp and Pinterest use the same social metadata as Facebook. X does the same if no X Cards tags are defined below.', 'wp-seopress'); ?>
                            </p>
                            ...
                            <p>
                                ...
                                <textarea id="seopress_social_fb_desc_meta" name="seopress_social_fb_desc"
                                    ...
                                    aria-label="<?php _e('Facebook description', 'wp-seopress'); ?>"><?php echo esc_html($seopress_social_fb_desc); ?></textarea>
                            </p>
                            <p>
                        ...
                        <div class="box-left">
                            ...
                            <p>
                                ...
                                <input id="seopress_social_twitter_title_meta" type="text"
                                    ...
                                    aria-label="<?php _e('X Title', 'wp-seopress'); ?>"
                            ...
                            <p>
                                ...
                                <textarea id="seopress_social_twitter_desc_meta" name="seopress_social_twitter_desc"
                                    ...
                                    aria-label="<?php _e('X description', 'wp-seopress'); ?>"><?php echo esc_html($seopress_social_twitter_desc); ?></textarea>
                            </p>
                            <p>
                        ...
                        <div class="box-right">
                            <div class="twitter-snippet-preview">
                                ...
                                <?php if ('1' == seopress_get_toggle_option('social')) { ?>
                                <p><?php _e('This is what your post will look like in X. You have to publish your post to get the X Preview.', 'wp-seopress'); ?>
                                </p>
                                <?php } else { ?>
                                ...
                                <div class="twitter-snippet-box">
                                    <div class="snippet-twitter-img-alert alert1" style="display:none">
                                        <p class="notice notice-error"><?php _e('File type not supported by X. Please choose another image.', 'wp-seopress'); ?>
                                        </p>
                                    </div>
                                    <div class="snippet-twitter-img-alert alert2" style="display:none">
                                        <p class="notice notice-error"><?php _e('Minimum size for X is <strong>144x144px</strong>. Please choose another image.', 'wp-seopress'); ?>
                                        </p>
                                    </div>
