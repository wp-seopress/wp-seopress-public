...
?>
    <div class="sp-section-header">
        <h2>
            <?php _e('Cookie bar / GDPR / Google Consent v2', 'wp-seopress'); ?>
        </h2>
    </div>
    <p>
    ...
    <div class="seopress-notice">
        <p>
            <?php _e('We automatically manage <strong>Google Consent v2</strong> with GA4 and our cookie bar.', 'wp-seopress'); ?>
        </p>
    </div>
