...
?>
    <div class="sp-section-header">
        <h2>
            <?php _e('LinkedIn', 'wp-seopress'); ?>
        </h2>
    </div>
    <p>
        <?php _e('LinkedIn uses the oembed JSON link to generate the share of your post, by retrieving the post title, its content and its featured image.', 'wp-seopress'); ?>
    </p>

    <div class="seopress-notice">
        <p>
            <?php _e('We generate the <strong>thumbnail URL</strong> of the oembed JSON feed in this order:', 'wp-seopress'); ?>
        </p>
