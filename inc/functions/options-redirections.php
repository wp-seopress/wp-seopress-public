 ...
 * Enabled
 *
 * @return string seopress_redirections_enabled
 */
 ...
 * Term Enabled
 *
 * @return string seopress_redirections_term_enabled
 */
 ...
 * Logged Status
 *
 * @return string seopress_redirections_logged_status
 */
 ...
 * Term Logged Status
 *
 * @return string seopress_redirections_term_logged_status
 */
 ...
 * Type
 *
 * @return string seopress_redirections_type
 */
 ...
 * Term Type
 *
 * @return string seopress_redirections_term_type
 */
 ...
 * URL to redirect
 *
 * @return string seopress_redirections_value
 */
function seopress_redirections_value() {
	...
	if ( is_singular() && get_post_meta( $post->ID, '_seopress_redirections_value', true ) ) {
		...
		if ( $seopress_redirections_query->have_posts() ) {
			...
			if ( in_array( $seopress_redirections_value, $all_titles, true ) ) {
				// Do redirect.
				return $seopress_redirections_value;
			}
			wp_reset_postdata();
...
function seopress_redirections_hook() {
	...
	$meta_value_by_logged_in = \is_user_logged_in() ? 'only_logged_in' : 'only_not_logged_in';
