...
class AdvancedSettings implements ExecuteHooks {
	...
	/**
	 * The Advanced Settings process post.
	 *
	 * @param \WP_REST_Request $request The request.
	 *
	 * @since 5.5
	...
	public function processPost( \WP_REST_Request $request ) {
		...
		update_option( 'seopress_advanced_option_name', $sanitized_options );

		do_action( 'seopress_advanced_settings_updated', $sanitized_options );
