 ...
 */
namespace SEOPress\Vendor\Google\Http;
...
class REST
{
    ...
    public static function doExecute(ClientInterface $client, RequestInterface $request, $expectedClass = null)
    {
        try {
            ...
            if (interface_exists('SEOPress\Vendor\GuzzleHttp\Message\ResponseInterface') && $response instanceof \SEOPress\Vendor\GuzzleHttp\Message\ResponseInterface) {
