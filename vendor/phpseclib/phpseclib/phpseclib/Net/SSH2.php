...
use SEOPress\Vendor\phpseclib3\Crypt\Blowfish;
use SEOPress\Vendor\phpseclib3\Crypt\ChaCha20;
...
use SEOPress\Vendor\phpseclib3\Crypt\Common\SymmetricKey;
...
use SEOPress\Vendor\phpseclib3\Crypt\RC4;
use SEOPress\Vendor\phpseclib3\Crypt\Rijndael;
use SEOPress\Vendor\phpseclib3\Crypt\RSA;
use SEOPress\Vendor\phpseclib3\Crypt\TripleDES;
// Used to do Diffie-Hellman key exchange and DSA/RSA signature verification.
use SEOPress\Vendor\phpseclib3\Crypt\Twofish;
use SEOPress\Vendor\phpseclib3\Exception\ConnectionClosedException;
use SEOPress\Vendor\phpseclib3\Exception\InsufficientSetupException;
use SEOPress\Vendor\phpseclib3\Exception\InvalidPacketLengthException;
use SEOPress\Vendor\phpseclib3\Exception\NoSupportedAlgorithmsException;
use SEOPress\Vendor\phpseclib3\Exception\TimeoutException;
use SEOPress\Vendor\phpseclib3\Exception\UnableToConnectException;
...
use SEOPress\Vendor\phpseclib3\System\SSH\Agent;
/**
 * Pure-PHP implementation of SSHv2.
 *
 * @author  Jim Wigginton <terrafrost@php.net>
...
class SSH2
{
    ...
    private function connect()
    {
        ...
        if (!is_resource($this->fsock)) {
            ...
            if (defined('SEOPress\Vendor\NET_SSH2_LOGGING')) {
    ...
    private function get_binary_packet()
    {
        ...
        if ($this->hmac_check instanceof Hash) {
            ...
            } else if (!hash_equals($hmac, $this->hmac_check->hash(pack('Na*', $this->get_seq_no, $reconstructed)))) {
                $this->disconnect_helper(NET_SSH2_DISCONNECT_MAC_ERROR);
    ...
    {
        if (defined('SEOPress\Vendor\NET_SSH2_LOGGING') && NET_SSH2_LOGGING == self::LOG_COMPLEX) {
