...
namespace SEOPress\Vendor\Psr\Log\Test;

use SEOPress\Vendor\Psr\Log\LoggerInterface;
use SEOPress\Vendor\Psr\Log\LogLevel;
use SEOPress\Vendor\PHPUnit\Framework\TestCase;
/**
...
abstract class LoggerInterfaceTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf('SEOPress\Vendor\Psr\Log\LoggerInterface', $this->getLogger());
    }
    /**
    ...
    public function testObjectCastToString()
    {
        if (method_exists($this, 'createPartialMock')) {
            $dummy = $this->createPartialMock('SEOPress\Vendor\Psr\Log\Test\DummyTest', array('__toString'));
        } else {
            $dummy = $this->getMock('SEOPress\Vendor\Psr\Log\Test\DummyTest', array('__toString'));
        }
